  ...
  return (
    <div className="absolute top-0 left-0 right-0 h-[600px] z-10 pointer-events-none overflow-hidden select-none">
       ...
       <div 
         ...
         style={{
           background: 'radial-gradient(circle at 25% 100%, #b83a3a 0%, transparent 60%), radial-gradient(circle at 75% 100%, #6366f1 0%, transparent 60%), radial-gradient(circle at 50% 115%, #fb923c 0%, transparent 60%)'
         }}
       />
    </div>
  )
