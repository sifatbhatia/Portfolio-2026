...
"[project]/sifPort/app/projects/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProjectsIndex() {
    _s();
    const [activeProjects, setActiveProjects] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$sifPort$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$sifPort$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectsIndex.useEffect": ()=>{
            ...
            const projectsWithThumbnails = [
                ...
                "ProjectsIndex.useEffect.projectsWithThumbnails": (project)=>({
                        ...project,
                        image: getProjectThumbnail(project.slug)
                    })
            }["ProjectsIndex.useEffect.projectsWithThumbnails"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$sifPort$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectsIndex.useEffect": ()=>{
            const check = {
                "ProjectsIndex.useEffect.check": ()=>setIsMobile(window.innerWidth < 1024)
            }["ProjectsIndex.useEffect.check"];
            check();
            window.addEventListener('resize', check);
            return ({
                "ProjectsIndex.useEffect": ()=>window.removeEventListener('resize', check)
            })["ProjectsIndex.useEffect"];
        }
    }["ProjectsIndex.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$sifPort$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectsIndex.useEffect": ()=>{
            ...
            }["ProjectsIndex.useEffect.ctx"], containerRef);
            return ({
                "ProjectsIndex.useEffect": ()=>ctx.revert()
            })["ProjectsIndex.useEffect"];
        }
    }["ProjectsIndex.useEffect"], [
        isMobile
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$sifPort$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectsIndex.useEffect": ()=>{
            const handleScroll = {
                "ProjectsIndex.useEffect.handleScroll": ()=>setIsScrolled(window.scrollY > 100)
            }["ProjectsIndex.useEffect.handleScroll"];
            window.addEventListener('scroll', handleScroll);
            return ({
                "ProjectsIndex.useEffect": ()=>window.removeEventListener('scroll', handleScroll)
            })["ProjectsIndex.useEffect"];
        }
    }["ProjectsIndex.useEffect"], []);
...
_s(ProjectsIndex, "LQW6C+7es8XsXRFn1ph22h3Bmvo=");
_c = ProjectsIndex;
var _c;
...
//# sourceMappingURL=sifPort_app_1abd70ec._.js.map