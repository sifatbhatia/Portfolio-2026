...
"[project]/SB/Lumen/app/signals/[slug]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
                ...
                try {
                    ...
                    if (res.ok) {
                        ...
                        const matched = data.find({
                            "SignalDetail.useEffect.fetchPulse.matched": (p)=>p.slug === slug
                        }["SignalDetail.useEffect.fetchPulse.matched"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$SB$2f$Lumen$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SignalDetail.useEffect": ()=>{
            if (pulse?.prompt && !generatedImageUrl && !isGenerating) {
                const generateImage = {
                    "SignalDetail.useEffect.generateImage": async ()=>{
                        // @ts-ignore
                ...
                }["SignalDetail.useEffect.generateImage"];
                generateImage();
            }
        }
    }["SignalDetail.useEffect"], [
...
_s(SignalDetail, "g6hKx+q8QOhoGj5aIB/3vtboOWk=", false, function() {
    return [
...
_c = SignalDetail;
var _c;
__turbopack_context__.k.register(_c, "SignalDetail");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=SB_Lumen_app_175c5db1._.js.map